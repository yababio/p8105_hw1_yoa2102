...
The penguins data set includes information about size measurements for adult foraging penguins near Palmer Station, Antarctica. This data set consists of the following variables: `r names(penguins)`. The data set contains `r ncol(penguins)` columns and  `r nrow(penguins)` rows. The mean flipper length for penguins in this data set is `r mean(pull(penguins, flipper_length_mm), na.rm = T)` mm.
