...
The mean flipper length for penguins in this data set is `r mean(pull(penguins, flipper_length_mm), na.rm = T)` with a standard deviation of `r sd(pull(penguins, flipper_length_mm), na.rm = T)` mm. 
